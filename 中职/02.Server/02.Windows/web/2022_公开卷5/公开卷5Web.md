...
## 样题拓扑图
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/toplog1.png)
...
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p1.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p2.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p3.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p4.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p5.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p6.png)
...
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p7.png)
...
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p9.png)

- 对于70以上的版本，我们需要添加启动参数，在桌面上的chrome浏览器图标上右键，在目标的最后面输入--ssl-version-max 1.2，强制将TLS版本指定为1.2就可以正常跳出客户端证书选择，并且正常访问网页了。
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p8.png)

- **3.通过IIS设置不检查跳过TLS 1.3检查:**
`开启IIS->选择站点->点击绑定->选择443端口的站点->勾选通过TCP禁用TLS 1.3->点击确定`
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p10.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷5/pics/p11.png)