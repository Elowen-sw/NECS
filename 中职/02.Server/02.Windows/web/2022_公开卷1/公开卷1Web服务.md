...
##__样题拓扑图:__
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/toplog1.png)
...
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p1.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p2.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p3.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p4.png)

- (2).回到证书模版右键:
`选择新建->要颁发的证书模版 `
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p5.png)
`选择工作站身份验证模版 的副本->确定 `
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p6.png)
...
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p7.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p8.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p9.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p10.png)
...
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p11.png)

 `在私钥选项卡中选择密钥选项->点击使私钥可以导出`
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p12.png)

`配置好之后，点击确定，选择这一封证书模版并且单击注册->选择完成，这样web服务器的验证证书就创建好了`
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p13.png)
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p14.png)

- (4).在IIS中应用这封证书
` 这封证书会直接进入IIS的证书库，不用再导入了`
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p15.png)

- (5).为站点添加https访问，并且绑定这封证书，然后进行访问测试先使用windowsIE浏览器进行测试

`我们首先使用https://www.skills.com这个域名进行访问`
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p16.png)
`我们发现证书没有报不安全的错误，接下来我们使用https://www1.skills.com`
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p17.png)
...
`这里我导入的根证书的信息如下:`
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p18.png)
...
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p19.png)
...
![logtop1](中职/02.Server/02.Windows/web/2022_公开卷1/pics/p20.png)
