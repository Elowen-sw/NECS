...
## 样题拓扑图
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/toplog1.png)
...
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p1.png)
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p2.png)
...
![logtop11](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p3.png)

+ (2).选择从属证书颁发机构:
` 右键复制模版 `
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p4.png)
`修改证书有效期为10年->勾选在Active Directoy中发布证书->选择安全选项卡将域管理权限赋齐`
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p5.png)
![logtop1](p5_1.png)

+ (3).回到证书模版右键:
`选择新建->要颁发的证书模版 `
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p6.png)
`选择从属证书颁发机构 的副本->确定 `
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p7.png)

+ (4).接下来我们需要在SubDC上先申请一封从属证书颁发机构证书，使用的证书模版为刚刚创建的**从属证书颁发机构 的副本
` 在SubDC上打开MMC->选择证书->选择计算机账户->点击个人->在空白处右键->所有任务->高级操作->创建自定义请求`
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p8.png)
`点击下一步->选择Active Directory 注册策略点击下一步->选择模版为[从属证书颁发机构 的副本]点击下一步`
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p9.png)
`点击详细信息->属性->设置证书基本信息:公用名=skills.com，国家 =CN，省 =Beijing，城市=Beijing，组织=Skills，组织单位=System->点击确定->点击下一步`
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p10.png)
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p11.png)
` 将脱机请求保存到桌面->保存文件名为subca.req文件格式为Base64->点击完成`
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p12.png)
...
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p13.png)
`将证书导入到Subca的本地计算机证书个人中`
![logtop1]pics/p14.png)
`安装Sub的企业从属CA证书颁发机构->在私钥选项卡选择使用现有私信->选择刚刚导入的从属颁发机构证书`
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p15.png)
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p16.png)
...
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p17.png)
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p18.png)
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p19.png)
` 打开DC的组策略颁发机构->在计算机配置-> Windows设置-> 安全设置->公钥策略->选择证书服务客户端-自动注册->在配置模式中选择启用->点击确定生效配置打开自动注册功能`
![logtop1](01.中职/02.Server/02.Windows/ca/2022_公开卷1/pics/p20.png)
